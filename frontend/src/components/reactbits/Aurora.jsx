...
// Upstream: https://github.com/DavidHDev/react-bits/tree/main/src/content/Backgrounds/Aurora
...
export default function Aurora(props) {
  const {
    colorStops = ["#bfdb80", "#def4a0", "#6c906b"],
    amplitude = 1.0,
    blend = 0.5,
    lightMode = false,
  } = props;
  ...
  }, [amplitude, blend, lightMode, reduced]);
